...
if __name__ == '__main__':
    # Default to epic Gerrit
    default_gerrit = 'https://review.epic-os.live'

    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
        repopick.py is a utility to simplify the process of cherry picking
        patches from epic's Gerrit instance (or any gerrit instance of your choosing)
    ...
    for change in change_numbers:
        ...
        mergables.append({
            ...
            'project': review['project'].replace("Epic-Rom/", ""),
